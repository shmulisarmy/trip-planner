...
import car_image_1 from "../../../assets/new_car1.svg";
import car_image_2 from "../../../assets/new_car2.svg";
import car_image_3 from "../../../assets/new_car3.png";
const car_image_4 =
    ...
    <>
      <div class="event-day">
        ...
        <div
          ...
          id={`event_container-${events_accesor_key}`}
        >
              ...
              return (
                <>
                  ...
                  <div style={buffer_style} class="buffer">
                    <img src={car_images[index % car_images.length]} alt="" />
                  </div>
                </>
              );
            }

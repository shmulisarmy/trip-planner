...
export function Event_C({
  ...
  const el: HTMLElement = (
    <div
      ...
      ondrag={() => {dragInfo.grabbing = {events_accesor_key, index}; el.style.display = "none"; hidden = el; drop_zone.style.height = `${duration*time_to_size_multiplier}px`; document.body.classList.add('durring-dragging')}}
      ...
      onDragEnd={() => {hidden.style.display = "block"; drop_zone.parentElement?.removeChild(drop_zone); document.body.classList.remove('durring-dragging')}}
    >
      <div
        class="top"
        style={{
